# Mise en route — ARC-MEM Bridge (ZORA_ARC)

Implémentation locale **100 % Ollama** de la base centrale ZORA ARC : ingestion
documentaire (PDF), embeddings **768 D**, stockage **PostgreSQL/PostGIS/pgvector**,
mémoire MemGraphRAG / H-MEM.
